...
<body>
	...
	<div class="modal-body">
		...
		<script type="text/javascript">
			$("#postcodify").postcodify({
				insertPostcode5 : "#receive_postcode5",
				insertAddress : "#receive_address",
				insertDetails : "#receive_details",
				insertExtraInfo : "#receive_extra_info",
		...
		<div>
			<p>
				<label for="entry_postcode6">우편번호</label><input type="text"
					class="form-control" id="receive_postcode5" readonly>
			</p>
			<p>
				<label for="entry_address">도로명주소</label><input type="text"
					class="form-control" id="receive_address" readonly>
			</p>
			<p>
				<label for="entry_address">참고항목</label><input type="text"
					class="form-control" id="receive_extra_info" readonly>
			</p>
			<p>
				<label for="entry_details">상세주소</label><input type="text"
					class="form-control" id="receive_details" />
			</p>
		</div>
	</div>
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-primary"
			onclick="insertCollectAddFunction();" data-dismiss="modal">확인</button>
	</div>
</body>
</html>