...
<div class="modal-body">
	...
	<div>
		<p>
			<label for="entry_postcode6">우편번호</label>
		...
		<p>
			<label for="entry_address">참고항목</label>
			<input type="text" class="form-control" id="entry_extra_info" readonly>
		</p>
		<p>
			<label for="entry_details">상세주소</label>
			<input type="text" class="form-control" id="entry_details" />
		</p>
	</div>
</div>
<div class="modal-footer">
	<button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
	<button type="button" class="btn btn-primary" onclick="insertAddFunction();" data-dismiss="modal">확인</button>
</div>
</body>
</html>